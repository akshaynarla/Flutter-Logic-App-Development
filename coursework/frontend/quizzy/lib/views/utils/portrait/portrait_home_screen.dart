...
class PortraitHomeScreen extends ConsumerWidget {
            ...
            child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const GreyButton(
                        routeStr: '/home/mode', buttonName: 'New Session'),
                    SizedBox(height: MediaQuery.sizeOf(context).height * 0.02),
                    const GreyButton(
                        routeStr: '/home/stats', buttonName: 'User Stats'),
                    SizedBox(height: MediaQuery.sizeOf(context).height * 0.02),
                    const GreyButton(
                          ...
                          if (serverRunning) {
                            ...
                            if (success) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                      content: Text(
                                          'Session Expired. Current session data might be lost!')));
                              context.go('/login');
                            }
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                    content: Text(
                                        'Server is offline. Data will be lost if you logout!')));
                            context.go('/login');
                          }
                        },
